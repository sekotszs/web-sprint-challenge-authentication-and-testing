...
Sessions are stored server side and tokens are stored client side.
2. What does `bcrypt` do to help us store passwords in a secure manner.
Bcrypt is a password hashing install that hashes a users password in order to protect.
3. How are unit tests different from integration and end-to-end testing.
Unit tests are more reliable than end to end testing. 
4. How _Test Driven Development_ changes the way we write applications and tests.
It is where you write a test before producing the code.
